...
describe('Application', () => {
  test('renders correctly', () => {
    ...
    const paragraphElement2 = screen.getByText('ields are manda', {
      exact: false,
    }); // substring match
    ...
    const termsElement3 = screen.getByLabelText('gree to the term', {
      exact: false,
    }); // substring match
    expect(termsElement3).toBeInTheDocument();

    const termsElement6 = screen.getByLabelText((content, element) =>
